            ...
            <div class="card">
                <div class="card-body cart">
                    <div class="col-sm-12 empty-cart-cls text-center">
                         ...
                         <img src="https://uat-app.viveks.com/static/frontend/MageBig/martfury_layout02/en_GB/images/empty-cart.svg" width="400" height="400" class="img-fluid mb-4 mr-3" alt='Empty Cart' />
